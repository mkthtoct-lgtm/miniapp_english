...
const Welcome = ({ onStart }) => {
  ...
  return (
    <>
      <div className={`w-full max-w-lg text-center fade-in relative z-10 transition-all duration-500 ${showTerms ? 'opacity-0 scale-95' : 'opacity-100 scale-100'}`}>
        ...
        <div className="mb-6">
          ...
          <div className="relative p-5 mb-8 overflow-hidden border shadow-2xl bg-white/10 backdrop-blur-xl rounded-3xl border-white/20">
            ...
            <div className="relative z-10 grid grid-cols-2 gap-3">
              {/* Listening Section - Đã thay sticker */}
              ...
              {/* Speaking Section (Logo cuối) - Đã thay sticker */}
